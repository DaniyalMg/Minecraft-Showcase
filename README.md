...
*   **خرید آنلاین پلن:** انتخاب نوع سرور (Survival, Creative, Minigames)، میزان رم و سی‌پی‌یو.
*   **اتوماسیون استقرار (Auto-Deployment):** راه‌اندازی خودکار سرور مجازی (VPS) یا کانتینر داکر پس از پرداخت موفق.
